...
namespace P4.Tests
{
    ...
    {
        PhotoCommentRepository _context;
        [SetUp]
        public void Setup()
        {
            ...
            .Options;
            _context = new PhotoCommentRepository(new AppDBContext(options));
            _context.Create(new PhotoComment { PhotoCommentId = Guid.Parse("31231234-1234-1242-1242-123412341234"), PhotoId = Guid.Parse("11111111-1111-1111-1111-111111111111"), UserId = Guid.Parse("11111111-1111-1111-1111-111111111111") });
        }
